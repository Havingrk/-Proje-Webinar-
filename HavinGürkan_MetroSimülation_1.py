...
if __name__ == "__main__":
    ...
    # Senaryo 2: Demetevler'den Keçiören'e
    print("\n2. Demetevler'den Keçiören'e:")
    rota = metro.en_az_aktarma_bul("T2", "T4")
    if rota:
        print("En az aktarmalı rota:", " -> ".join(i.ad for i in rota))

    sonuc = metro.en_hizli_rota_bul("T2", "T4")
    if sonuc:
        rota, sure = sonuc
        print(f"En hızlı rota ({sure} dakika):", " -> ".join(i.ad for i in rota))

    # Senaryo 3: Gar'dan AŞTİ'ye
    print("\n3. Gar'dan AŞTİ'ye:")
    rota = metro.en_az_aktarma_bul("T3", "M1")
    if rota:
        print("En az aktarmalı rota:", " -> ".join(i.ad for i in rota))

    sonuc = metro.en_hizli_rota_bul("T3", "M1")
    if sonuc:
        rota, sure = sonuc
        print(f"En hızlı rota ({sure} dakika):", " -> ".join(i.ad for i in rota))